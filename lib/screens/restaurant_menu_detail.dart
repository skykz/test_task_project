...
import 'package:test_task_project/resources/widgets/menu_food_card.dart';
...
class _RestaurantMenuDetailState extends State<RestaurantMenuDetail>
    ...
    return SafeArea(
      child: Consumer<HomeProvider>(builder: (context, provider, child) {
        return Scaffold(
          appBar: _buildAppBar(),
          body:
              provider.getLoadingState ? _loaderWidget() : _buildBody(provider),
        );
      }),
    );
  }
  ...
  Column _buildBody(HomeProvider provider) {
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: TabBar(
                      ...
                      tabs:
                          provider.getRestaurantMenu.categories.map((category) {
                        return SizedBox(
                          child: Tab(
                            child: Padding(
                      ...
                      return AutoScrollTag(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              GridView.builder(
                                itemCount: provider.getRestaurantMenu
                                    .categories[j].dishes.length,
                                shrinkWrap: true,
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return Padding(
                                    ...
                                    child: MenuFoodCard(
                                      dish: provider.getRestaurantMenu
                                          .categories[j].dishes[index],
